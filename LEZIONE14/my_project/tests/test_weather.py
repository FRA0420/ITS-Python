...
'''def test_check_weather1():
    assert check_weather(21.00) == "hot",'temperatures greater than \
        20 degree must be considered as hot'
...
def test_check_weather3():
    assert check_weather(5.00) == "cold",'temperatures lower than \
        10 degree must be considered as cold'
...
def test_check_weather5():
    assert check_weather(30.00) == "hot",'temperatures greater than \
        20 degree must be considered as hot'
    assert check_weather(11.00) == "cold",'temperatures lower than \
        10 degree must be considered as cold'
'''
...
def test_check_weather(temperature,expected):
    ae:str = ""
    if temperature < 20:
        ae = "temperatures greater than \
        20 degree must be considered as hot"
    elif 10 < temperature <= 20:
        ae = "temperatures between 10 and 20 degree \
        must be considered as average temperature"

    else:
        ae = "temperatures lower than \
        10 degree must be considered as cold"
